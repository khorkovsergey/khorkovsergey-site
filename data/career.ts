  ...
  stages: [
    {
      ...
      responsibilities: [
        'Трансформация ключевых ИТ-процессов',
        'Внедрение Jira и Confluence как единой платформы управления',
        'Запуск Task & Process Mining',
        'SAP-based внутренние цифровые решения',
        'KPI-дашборды и инструменты прозрачности',
        'Инициативы операционной эффективности',
      ],
      tools: ['Jira', 'Confluence', 'Task & Process Mining', 'SAP', 'FineBI', 'Dashboards'],
  ...
  stages: [
    {
      ...
      responsibilities: [
        'Transformation of key IT processes',
        'Implementation of Jira and Confluence as a unified management platform',
